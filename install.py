...
os.system("sudo ln -s /opt/r3it/r3it/cert.{s..t}* /etc/systemd/system/")
...
os.system("sudo touch /etc/authbind/byport/{80,443}")
os.system("sudo chown r3it:r3it /etc/authbind/byport/{80,443}")
os.system("sudo chmod 710 /etc/authbind/byport/{80,443}")
